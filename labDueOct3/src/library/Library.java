...
public class Library {
	...
	public static void main (String args[]) {
		...
		lib.checkout("Goofy", "February 28, 2012", "12345"); // should fail, the book doesnt exist
		lib.checkout("Someone", "August 1, 2018", "QA43.W34"); //should fail, the book was checked out
		lib.checkout("Person", "September 1, 2018", "QA76.73.B3W335");//should fail, reference book cant be checked out
		
		lib.returned("QA76.6.W3275");
		lib.returned("64.2 R25ex"); //should fail, reference book
		lib.returned("QA76.6.W3275"); // should fail, book was returned
